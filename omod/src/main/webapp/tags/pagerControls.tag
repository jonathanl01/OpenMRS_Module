...
<input type="button"
	...
	title="<spring:message code="basicmodule.pager.first" />"
/>
...
<input type="button"
	...
	title="<spring:message code="basicmodule.pager.previous" />"
/>
...
<input type="button"
	...
	onclick="pager_set_offset(${pagingInfo.pageOffset + pagingInfo.pageSize})"
	title="<spring:message code="basicmodule.pager.next" />"
/>
...
<input type="button"
	...
	title="<spring:message code="basicmodule.pager.last" />"
/>